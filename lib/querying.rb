...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.id, subgenres.id FROM authors JOIN subgenres ON subgenres.id = authors.id  ORDER BY authors.name ASC"
end

def select_series_title_with_most_human_characters
  "SELECT characters.series_id, MAX(characters) FROM series JOIN characters ON characters.series_id =  "
end
